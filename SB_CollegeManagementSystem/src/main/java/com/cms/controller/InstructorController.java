...
public class InstructorController {
	...
	public String showAllInstructors(AbstractMultipartHttpServletRequest request){
	...
	public String  getInstructorProfile(@PathVariable("id") int id , AbstractMultipartHttpServletRequest request)
	{
//		
...
//		
	...
	public String addInstructorProfileData(AbstractMultipartHttpServletRequest request) {
	...
	public String editInstructorProfile(@RequestParam int id,AbstractMultipartHttpServletRequest request) {
