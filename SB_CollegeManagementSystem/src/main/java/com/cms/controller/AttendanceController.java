...
public class AttendanceController {
	...
	public String saveCourseIndataBase(@ModelAttribute Attendance attendance , BindingResult binding , AbstractMultipartHttpServletRequest request ,ModelMap model , @RequestParam String coursename , @RequestParam String secorder ){
	...
	public String showAllCourse(AbstractMultipartHttpServletRequest request){
		request.setAttribute("courses", courseServcie.getAllCourses());
		request.setAttribute("mode", "ALL_COURSES");
	...
	public String showAllCourse2(AbstractMultipartHttpServletRequest request){
		request.setAttribute("courses", courseServcie.getAllCourses());
		request.setAttribute("mode", "ALL_COURSES");
	...
	public String showexceededCourse(AbstractMultipartHttpServletRequest request){
		request.setAttribute("courses", courseServcie.getAllCourses());
		request.setAttribute("mode", "ALL_COURSES");
	...
	public String showtotalattenCourse(AbstractMultipartHttpServletRequest request){
		request.setAttribute("courses", courseServcie.getAllCourses());
		request.setAttribute("mode", "ALL_COURSES");
	...
	public String deleteattCourse(AbstractMultipartHttpServletRequest request){
		request.setAttribute("courses", courseServcie.getAllCourses());
		request.setAttribute("mode", "ALL_COURSES");
	...
	@RequestMapping("/editattendance")
	public String editatt(@RequestParam int id,AbstractMultipartHttpServletRequest request , ModelMap model ,   @RequestParam String coursename , @RequestParam String secorder ) {
